		...
		<div class="container">
				    ...
				    <div style="margin-left: 5px ">
                        <a href="{{route('dangnhap')}}">
                        	<button type='button' class='btn btn-outline-info btn-sm'>Đăng nhập</button>
                        </a>
...
<!-- info -->
	...
	<div class="container mt-1" style="text-align: center">
		<div class="row">
			<div style=" margin-left: 12em">
				<img src="{{asset('IMG/slide/4.jpg')}}" style="width: 50rem; height: 20rem;">
	...
	<div class="container" style="text-align: center; padding: 30px;">
		...
		<div class="row" style="margin-left: 8rem">
			<div class="col-md-3">
				<img src="{{asset('IMG/dichvu/DINING.jpg')}}" style="width: 16rem; height: 20rem;">
				<div class="nameroom">
					ĂN TỐI
				</div>
			</div>
			<div class="col-md-3">
				<img src="{{asset('IMG/dichvu/SPA.jpg')}}" style="width: 16rem; height: 20rem;margin-left: 3rem">
				<div class="name_sv">
					ăn tối
				</div>
			</div>
			<div class="col-md-3">
				<img src="{{asset('IMG/dichvu/EVENT.jpg')}}" style="width: 16rem; height: 20rem;margin-left: 6rem">
				<div class="nameroom">
					SỰ KIỆN
				</div>
			</div>
